...
#define configMINIMAL_STACK_SIZE				( ( unsigned short ) 16384 ) /* In this simulated case, the stack only has to hold one small structure as the real stack is part of the win32 thread. */
